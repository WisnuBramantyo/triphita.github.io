...
<body>
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand" href="index.html">Triphita<span>Eco Tours and Hotels</span></a>
											...
											<div class="row no-gutters">
												...
												<div class="col-md d-flex">
                                                    <div class="form-group p-4">
														...
														{{-- <input type="number" name="duration" placeholder="Duration (hours)" class="form-control" /> --}}
                                                    </div>
                                                </div>
												<div class="col-lg d-flex">
													<div class="form-group p-4">
														...
														{{-- free text field option --}}
														{{-- <input type="number" name="price" step="0.01" placeholder="Max price" class="form-control" /> --}}
													</div>
												</div>
												<div class="col-md d-flex">
                                                    <div class="form-group p-4">
														...
														{{-- free text field option --}}
														{{-- <input type="number" name="adults" placeholder="Adults" class="form-control" /> --}}
                                                    </div>
                                                </div>
                                                <div class="col-md d-flex">
                                                    <div class="form-group p-4">
